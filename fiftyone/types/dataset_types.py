...
class YOLOCustomDataset(ImageDetectionDataset):
    """A labeled dataset consisting of images and their associated object
    detections saved in `YOLO format <https://github.com/AlexeyAB/darknet>`_.
    ...
    def get_dataset_importer_cls(self):
        import fiftyone.utils.yoloCustom as fouyc

        return fouyc.YOLOCustomDatasetImporter

    def get_dataset_exporter_cls(self):
        import fiftyone.utils.yoloCustom as fouyc

        return fouyc.YOLOCustomDatasetExporter
